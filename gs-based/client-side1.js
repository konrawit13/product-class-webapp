      ...
      */
      ...
      class prodClass {
        constructor() {
          document.addEventListener('DOMContentLoaded', () => {
            ...
            this.data = google.script.run
              ...
              .fetchDriveJSON('1DGqx6MBbFHC9cJxrhZHhKEnLIkhKgz8R');
          });
        ...
        onFetchSuccess(blob) {
          ...
          span.innerText = 'Ready state';
          div.appendChild(span);
          const acc_btn = document.querySelector('#accept_btn');
          acc_btn.removeAttribute("disabled");
